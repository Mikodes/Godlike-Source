...
{
	"You just got rekt by JUNKCODE!?!?!?",
	"Get Good! Get JUNKCODE!?!?!",
	"I'm not cheating, but If I was I would recommend JUNKCODE?!!?",
	"JUNKCODE!?!?!? > all",
	"Never fear vac with JUNKCODE!?!? Private",
	"Stop being a noob nigger, get JUNKCODE!?!?"
};
